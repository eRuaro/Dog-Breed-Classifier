...
def process_image(image_path, img_size=24):
    """
...
model = load_model('C:\\Users\\Erickson Neil Ruaro\\Documents\\GitHub\\Dog-Breed-Classifier\\model\\20210704-01-M1625361368-full-image-set-mobilenetv2-Adam.h5')
print('model loaded')
